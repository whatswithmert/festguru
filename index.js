  ...
  try {
    ...
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 1000,
        system: 'You are an electronic music festival expert. Given user preferences and festival data, recommend the best 3 festivals. Respond ONLY with raw JSON: {"story": "...", "picks": [{"name": "...", "reason": "...", "score": 0}]}. Story max 60 words. Reason max 20 words each. Score 0-10.',
